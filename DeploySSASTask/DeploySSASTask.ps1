...
try {
	...
	{ 
		...
		2019 {$compiler = "C:\Program Files (x86)\Microsoft SQL Server\150\Tools\Binn\ManagementStudio\Microsoft.AnalysisServices.Deployment.exe"}
		"auto" {
			if (Test-Path("C:\Program Files (x86)\Microsoft SQL Server\150\Tools\Binn\ManagementStudio\Microsoft.AnalysisServices.Deployment.exe")) { $compiler = "C:\Program Files (x86)\Microsoft SQL Server\150\Tools\Binn\ManagementStudio\Microsoft.AnalysisServices.Deployment.exe"}
